...
# LESSONS.md — System of Work Assistant (eval & test harness)

> Full prose for every lesson logged during work in `packages/evals/`. The compact index lives in `packages/evals/CLAUDE.md` "Lessons logged" table.
>
