...
// header for the full barrel-registration + migration rationale and the safety-rule-7
// column note.
//
// IDENTICAL column names + portable types to the SQLite table, per this package's
// both-dialect convention (task 24.39/24.43's coverage detector expects the two
// barrels to agree exactly).
