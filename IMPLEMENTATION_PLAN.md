...
- **§ARM-18 auto-ingest ENABLE crossing SEALED LIVE 2026-07-24** (`30ef70e0`) — maiden auto-ingest-armed real subscription extraction over a throwaway test vault: note `sources/ws-gate6-testvault/5090325d…md`, $0.054601, all safety held, gate-3 control-var unknown CLOSED live. Step B (in-app watcher auto-fire) = documented owner-run follow-up (runbook §6). Session doc 106.
- **⭐ OSB-PARITY amendment INTEGRATED 2026-07-24 (owner-approved AS IS; planning-only, all dormant, nothing armed).** ARCHITECTURE: KN-10/KN-11/KN-12 (§6 living-vault synthesis + governed auto-link/backlink + structural-file parity), RES-1/RES-2 (§7 governed web-research provider), §19.13 + REQ-F-021/022 + Spec-Index rows. IMPLEMENTATION_PLAN: 13.8→13.8a–e (EntityResolver [net-new load-bearing gap] · LinkHealer · confined planner · ingest-rewrite+index/log parity · scheduled synthesis), new 13.13/13.14 (research provider + flows), §ARM-RESEARCH ledger, Phase 26 (crossing 8, owner-gated). Code anchors VERIFIED (no drift; EntityResolver/LinkHealer confirmed ABSENT; ProviderId=`enums.ts:14` 5 members). Source: `docs/planning/osb-parity-amendment-proposal.md`. plan-lint clean. Session doc 107.
- **NEXT (owner/lead-sequenced):** build the dormant OSB-parity slices (13.8a–e deterministic-TDD + 13.13/13.14; research/synthesis armed only at Phase 26/§ARM-RESEARCH) — OR the standing Carry-forward set (SPINE · 7.19 retention · Phase-9 `/phase-exit` · 11.2 · FailureClass enum · /design-review · ESLint). Suite 6413 green.
