...
- **Queued MAJOR arc (owner-confirmed, post-Phase-9):** §13.8 living-vault synthesis (13.8a→e keystone) EXTENDED with the Granola gaps — **13.8f** meeting-path synthesis rewrite · **13.8g** attendee→person-entity resolution (⚠ verify ARCH §9 workflow-1 L297 unimplemented-spec anchor) · **23.8** Granola SPINE + Carry-forward-#1 amendment · the 2 new gaps (structured Task/Project priority model + retrieval re-ranker) — all subagent-authored, ANCHOR-VERIFY before canonical; lead routes at the §13.8 integration point. Standing Carry-forward: SPINE · 7.19 retention · 11.2 · FailureClass enum · ESLint.
