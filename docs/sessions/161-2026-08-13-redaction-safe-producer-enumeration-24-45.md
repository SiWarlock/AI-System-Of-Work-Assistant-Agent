...
- **Pre-existing, untouched:** a null `sourceWorkspace` still throws at the referential pin and the `defaultVisibility` guard — a §16 never-throw violation now **documented in-file** rather than left implied.
