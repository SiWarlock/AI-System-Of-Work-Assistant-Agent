...
| ⭐ ARC-4 keystone | 🔶 CORE DONE | **13.8a→b→c→d COMPLETE** + 13.16 producer+renderer + 13.8c-eval. **Remaining: 13.8f meeting-path · 13.8g attendee→person · 13.8d worker-binding (wire `rewriteVaultForSource`→`runSourceIngestion` + realpath containment L17).** |
