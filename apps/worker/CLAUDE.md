...
⛔ **THE FULL 82-ROW INDEX MOVED TO `apps/worker/LESSONS-INDEX.md`** on 2026-08-29 (byte-for-byte,
~18k tokens of this file's ~21k). ⚠ **Unlike `packages/contracts/CLAUDE.md`, NO core subset was kept
here** — there is no measurement of which worker lessons actually fire, and a core picked by taste
would carry authority it never earned. **Read `LESSONS-INDEX.md` directly** when auditing, reviewing
a diff, repairing a durable claim, building a guard, or closing out a round.
