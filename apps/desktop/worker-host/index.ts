...
export interface WorkerHostConfig {
  ...
  /** The owner switch for REAL Linear writes (plain data from `SOW_LINEAR_WRITES`; this host builds the
   *  transport). Default absent ⇒ off. Mirrors main/worker-supervisor.ts. */
